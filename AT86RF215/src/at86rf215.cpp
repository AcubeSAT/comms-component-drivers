...
void AT86RF215::set_state(Transceiver transceiver, State state_cmd, Error &err) {
...
void AT86RF215::set_pll_channel_spacing(Transceiver transceiver, uint8_t spacing, Error &err) {
...
uint8_t AT86RF215::get_pll_channel_spacing(Transceiver transceiver, Error &err) {
    RegisterAddress regscs;
...
void AT86RF215::set_pll_frequency(Transceiver transceiver, uint8_t freq, Error &err) {
    RegisterAddress regpll;
...
int8_t AT86RF215::get_receiver_energy_detection(Transceiver transceiver, Error &err) {
